  ...
  const content = (
    <div className="p-6 md:p-8 text-center">
      ...
      <button 
        ...
        className="w-full flex items-center justify-center gap-3 bg-white border-2 border-border-light text-text-main px-4 py-3 rounded-full font-bold hover:bg-stone-50 transition-colors shadow-sm mb-4"
      >
      ...
      {!isDesktop && (
        <button onClick={onClose} className="text-sm font-semibold text-text-light hover:text-text-main">
          Nanti saja
        </button>
      )}
    </div>
